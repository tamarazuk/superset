...
export const catppuccinMacchiatoTheme: Theme = {
  ...
  type: "dark",
  author: "Catppuccin",
  description: "Catppuccin Macchiato theme for Superset",
  ui: {
    background: "#24273a",
    foreground: "#cad3f5",
    card: "#1e2030",
    ...
    tertiary: "#181825",
    tertiaryActive: "#363a4f",
    destructive: "#ed8796",
    destructiveForeground: "#181825",
    border: "#494d64",
    input: "#494d64",
    ring: "#c6a0f6",
    sidebar: "#1e2030",
    ...
    sidebarPrimaryForeground: "#181825",
    ...
    chart4: "#8aadf4",
    chart5: "#ed8796",
    highlightMatch: "rgba(198, 160, 246, 0.2)",
    highlightActive: "rgba(198, 160, 246, 0.5)"
  },
  terminal: {
    background: "#24273a",
    foreground: "#cad3f5",
