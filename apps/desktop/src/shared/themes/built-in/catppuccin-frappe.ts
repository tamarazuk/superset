...
export const catppuccinFrappeTheme: Theme = {
  ...
  type: "dark",
  author: "Catppuccin",
  description: "Catppuccin Frappé theme for Superset",
  ui: {
    background: "#303446",
    foreground: "#c6d0f5",
    card: "#292c3c",
    ...
    tertiary: "#232634",
    tertiaryActive: "#414559",
    destructive: "#e78284",
    destructiveForeground: "#232634",
    border: "#51576d",
    input: "#51576d",
    ring: "#ca9ee6",
    sidebar: "#292c3c",
    ...
    chart4: "#8caaee",
    chart5: "#e78284",
    highlightMatch: "rgba(202, 158, 230, 0.2)",
    highlightActive: "rgba(202, 158, 230, 0.5)"
  },
  terminal: {
    background: "#303446",
    foreground: "#c6d0f5",
